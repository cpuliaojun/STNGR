...
# import functions
from utils import clean_mols, read_smiles

### CLI
parser = argparse.ArgumentParser(
        description='Calculate a series of properties for a set of SMILES')
# parser.add_argument('--smiles_file', type=str,
#                     help='file containing SMILES',default='./../model_sample/sc2mol_task3_output.csv')
parser.add_argument('--smiles_file', type=str,
                    help='file containing SMILES',default='./../cal_outcome/sorted_res.csv')

# parser.add_argument('--smiles_file', type=str,
#                     help='file containing SMILES',default='./../data/cleaned_HighResNpsTrain.txt')

parser.add_argument('--reference_file', type=str,
                    help='file containing a reference set of SMILES',default='./../data/cleaned_HighResNpsTrain.txt')
parser.add_argument('--output_dir', type=str,
                    help='directory to save output to',default='./../cal_outcome/')
...
output_file = os.path.join(args.output_dir, split[0] + "-outcomes.csv")
...
# smiles = pd.read_csv(args.smiles_file)['output'].to_list()
smiles = pd.read_csv(args.smiles_file)['smiles'].to_list()
